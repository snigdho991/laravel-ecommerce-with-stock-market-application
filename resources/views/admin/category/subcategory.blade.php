          ...
          <div class="table-wrapper">
           ...
           @foreach($subcategories as $key=>$subcategory)
                ...
                <tr>
                  ...
                  <td> 
                    <a href="" class="btn btn-sm btn-info" style="margin-right: 5px;" data-toggle="modal" data-target="#modaldemo2" data-subcatid="{{ $subcategory->id }}" data-catslug="{{ $subcategory->category_slug }}" data-subcategory="{{ $subcategory->subcategory_name }}"> <i class="fa fa-pencil"></i> Edit </a>
