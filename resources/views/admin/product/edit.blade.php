        ...
        @csrf
          <div class="row">
            ...
            <div class="col-lg mg-t-10 mg-lg-t-0">
              ...
              <input class="form-control" name="product_code" id="product_code" value="{{ $product->product_code }}" type="text" required>
            </div><!-- col -->
            <div class="col-lg mg-t-10 mg-lg-t-0">
              <label><b> &#129191; Product Price (*)</b></label>
              <input class="form-control" name="product_price" id="product_price" step="any" min="1" value="{{ $product->product_price }}" type="number" required>
            </div><!-- col -->
          </div><!-- row -->
          ...
          <div class="row mg-t-20">
            <div class="col-lg">
              ...
              <input class="form-control" name="product_weight" id="product_weight" value="{{ $product->product_weight }}" type="text">
            </div><!-- col -->
            <div class="col-lg mg-t-10 mg-lg-t-0">
              <label><b> &#129191; Product Discount</b></label>
              <input class="form-control" name="product_discount" id="product_discount" value="{{ $product->product_discount }}" step="any" min="0.1" type="number">
            </div><!-- col -->
            <div class="col-lg mg-t-10 mg-lg-t-0">
              <label><b> &#129191;  Product Video Link</b></label>
              <input class="form-control" name="product_video" id="product_video" value="{{ $product->product_video }}" type="text">
            </div><!-- col -->
          </div><!-- row -->
          ...
          <div class="row mg-t-20">
              <div class="col-lg">
                  ...
                  <input class="form-control" name="meta_title" id="meta_title" value="{{ $product->meta_title }}" type="text">
              </div><!-- col -->
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  <label><b> &#129191; Meta Keywords</b></label>
                  <input class="form-control" name="meta_keywords" id="meta_keywords" value="{{ $product->meta_keywords }}" type="text">
              </div><!-- col -->
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  <label><b> &#129191; Meta Description</b></label>
                  <input class="form-control" name="meta_description" id="meta_description" value="{{ $product->meta_description }}" type="text">
              </div><!-- col -->
          </div><!-- row -->
          ...
          <div class="row mg-t-20">
              <div class="col-lg">
                  ...
                  <input class="form-control" name="colorway" id="colorway" value="{{ $product->colorway }}" type="text">
              </div><!-- col -->
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  ...
                  <select name="occasion" class="form-control">
                      ...
                      @foreach($occasionArray as $occasion)
                        <option value="{{ $occasion }}" @if($occasion == $product->occasion) selected="" @endif>{{$occasion}}</option>
                      @endforeach
              ...
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  ...
                  <label class="ckbox" style="margin-top: 40px; cursor: pointer; font-weight: bold;">
                      <input type="checkbox" @if($product->status == 1) checked="" @endif name="home_slider"><span> Home Slider</span>
                  </label>
                  ...
                  <div class="card bd-0 wd-xs-300">
                    <br>
                        @if(!empty($product->main_image) && file_exists('app/uploads/product_images/main_image/small/'.$product->main_image))
                            <img width="270px" height="200px" id="remove_main" src="{{ asset('app/uploads/product_images/main_image/small/'.$product->main_image) }}">
                        @else
                            <span id="remove_main">Not Avalable</span>
                        @endif
                    <div id="preview">
              ...
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  ...
                  <div class="card bd-0 wd-xs-300">
                    ...
                    @if(!empty($product->second_image) && file_exists('app/uploads/product_images/second_image/small/'.$product->second_image))
                      <img width="270px" height="200px" id="remove_two" src="{{ asset('app/uploads/product_images/second_image/small/'.$product->second_image) }}">
                    @else
                      <span id="remove_two">Not Avalable</span>
                    @endif
              ...
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  ...
                  <div class="card bd-0 wd-xs-300">
                    ...
                    @if(!empty($product->third_image) && file_exists('app/uploads/product_images/third_image/small/'.$product->third_image))
                      <img width="270px" height="200px" id="remove_three" src="{{ asset('app/uploads/product_images/third_image/small/'.$product->third_image) }}">
                    @else
                      <span id="remove_three">Not Avalable</span>
                    @endif
              ...
              <div class="col-lg">
                  ...
                  <select class="form-control select2" id="catslug" name="category_slug" required>
                      ...
                      @foreach($categories as $category)
                        <option value="{{ $category->id }}" @if($category->id == $product->category_id) selected="" @endif data-catslug="{{ $category->category_slug }}">{{ $category->category_name }}</option>
                      @endforeach
              ...
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  ...
                  <select class="form-control" id="subslug" name="subcategory_slug">
                      ...
                      @foreach($subcategories as $subcategory)
                        <option value="{{ $subcategory->id }}" @if($subcategory->id == $product->subcategory_id) selected="" @endif data-subslug="{{ $subcategory->subcategory_slug }}">{{ $subcategory->subcategory_name }}</option>
                      @endforeach
                  </select>
              </div><!-- col -->
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  ...
                  <select class="form-control" name="childsubcategory_slug">
                      ...
                      @foreach($childsubcategories as $childsubcategory)
                        <option value="{{ $childsubcategory->id }}" @if($childsubcategory->id == $product->child_subcategory_id) selected="" @endif>{{ $childsubcategory->childsubcategory_name }}</option>
                      @endforeach
                  </select>
              </div><!-- col -->
          </div><!-- row -->
          ...
          <div class="row mg-t-20">
              <div class="col-lg mg-t-10 mg-lg-t-0">
                  <button type="submit" style="cursor: pointer;margin-top: 30px;width: 100%;" class="btn btn-info pd-x-35">Update Product</button>
              </div>
          </div>
